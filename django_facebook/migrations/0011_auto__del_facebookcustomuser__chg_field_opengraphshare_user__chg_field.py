...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('django_facebook_open_graph_share', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'FacebookInvite.user'
        db.alter_column('django_facebook_facebook_invite', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'FacebookProfile.user'
        db.alter_column(u'django_facebook_facebookprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.User'], unique=True))
