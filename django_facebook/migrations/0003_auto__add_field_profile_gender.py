...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_facebook.facebookuser', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookUser.gender'
        db.delete_column('django_facebook.facebookuser', 'gender')
