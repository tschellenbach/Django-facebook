...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookProfile.fb_update_required'
        db.add_column('django_facebook_facebookprofile', 'fb_update_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookProfile.fb_update_required'
        db.delete_column('django_facebook_facebookprofile', 'fb_update_required')
    ...
    models = {
        ...
        'django_facebook.facebookprofile': {
            ...
            'fb_update_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
