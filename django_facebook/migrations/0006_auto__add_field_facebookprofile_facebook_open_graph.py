...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookProfile.facebook_open_graph'
        db.add_column('django_facebook_facebookprofile', 'facebook_open_graph', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookProfile.facebook_open_graph'
        db.delete_column('django_facebook_facebookprofile', 'facebook_open_graph')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 12, 45, 13, 534000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 12, 45, 13, 534000)'}),
