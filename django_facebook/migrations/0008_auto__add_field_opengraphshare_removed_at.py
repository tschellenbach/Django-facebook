...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_facebook_open_graph_share', 'removed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 18, 16, 51, 16, 749000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 18, 16, 51, 16, 749000)'}),
