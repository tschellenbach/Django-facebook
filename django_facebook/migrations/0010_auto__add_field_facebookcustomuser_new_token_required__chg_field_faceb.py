...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookCustomUser.new_token_required'
        db.add_column(u'django_facebook_facebookcustomuser', 'new_token_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'FacebookCustomUser.facebook_open_graph'
        db.alter_column(u'django_facebook_facebookcustomuser', 'facebook_open_graph', self.gf('django.db.models.fields.NullBooleanField')(null=True))
        # Adding field 'FacebookProfile.new_token_required'
        db.add_column(u'django_facebook_facebookprofile', 'new_token_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'FacebookProfile.facebook_open_graph'
        db.alter_column(u'django_facebook_facebookprofile', 'facebook_open_graph', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):
        # Deleting field 'FacebookCustomUser.new_token_required'
        db.delete_column(u'django_facebook_facebookcustomuser', 'new_token_required')


        # Changing field 'FacebookCustomUser.facebook_open_graph'
        db.alter_column(u'django_facebook_facebookcustomuser', 'facebook_open_graph', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'FacebookProfile.new_token_required'
        db.delete_column(u'django_facebook_facebookprofile', 'new_token_required')


        # Changing field 'FacebookProfile.facebook_open_graph'
        db.alter_column(u'django_facebook_facebookprofile', 'facebook_open_graph', self.gf('django.db.models.fields.BooleanField')())
