...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenGraphShare.removed_at'
        db.add_column('django_facebook_open_graph_share', 'removed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookUser.raw_data'
        db.add_column('django_facebook_facebookuser', 'raw_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenGraphShare.removed_at'
        db.delete_column('django_facebook_open_graph_share', 'removed_at')

        # Deleting field 'FacebookUser.raw_data'
        db.delete_column('django_facebook_facebookuser', 'raw_data')
